<template>
  <div class="public">
    ...
    <div class="content">
      <div class="data_now">
        ...
        <div class="coin_data">
          ...
          <div class="data_right">
            ...
            <p><span>24H:</span><span>{{coinCurrent.num}}</span></p>
      ...
      <!--  <div class="data_btn">
        <span @click="goBuy(area,symbol,0)">买入</span>
        <span @click="goSell(area,symbol,1)">卖出</span>
      </div> -->
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getData(res) {
        ...
        // console.log(res,1)
        if (res.status == 1) {
          that.coinCurrent = res.data.pair[0];
          ...
          that.coinCurrent.range = that.checkPrice(that.coinCurrent.ratio);
